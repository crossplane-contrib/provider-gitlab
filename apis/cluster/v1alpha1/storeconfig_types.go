...
type StoreConfigSpec struct {
	// DefaultScope is the default scope used by this store config.
...
// GetStoreConfig returns the store config spec
func (in *StoreConfig) GetStoreConfig() StoreConfigSpec {
	return in.Spec
}
