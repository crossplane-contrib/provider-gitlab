...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImportUrlSecretRef) DeepCopyInto(out *ImportUrlSecretRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImportUrlSecretRef.
func (in *ImportUrlSecretRef) DeepCopy() *ImportUrlSecretRef {
	if in == nil {
		return nil
	}
	out := new(ImportUrlSecretRef)
	in.DeepCopyInto(out)
	return out
}
