...
type CommonRunnerParameters struct {
	...
	// +kubebuilder:example="Docker runner for CI/CD"
	// +optional
	...
	// +kubebuilder:example={docker,linux}
	// +optional
	...
	// +kubebuilder:example="not_protected"
	// +optional
	...
	// +kubebuilder:example="Scheduled maintenance on weekends"
	// +optional
