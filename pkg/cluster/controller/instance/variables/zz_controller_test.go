	...
	cases := map[string]struct {
		...
		"DeletingEarlyReturnSkipsSecret": {
			args: args{
				...
				cr: variable(withDeletionTimestamp(), withSpec(v1alpha1.VariableParameters{CommonVariableParameters: commonv1alpha1.CommonVariableParameters{Key: variableKey}, ValueSecretRef: common.TestCreateSecretKeySelector("", "blah")}), withConditions(v2.Deleting())),
			},
			want: want{cr: variable(withDeletionTimestamp(), withSpec(v1alpha1.VariableParameters{CommonVariableParameters: commonv1alpha1.CommonVariableParameters{Key: variableKey}, ValueSecretRef: common.TestCreateSecretKeySelector("", "blah")}), withConditions(v2.Deleting())), result: managed.ExternalObservation{ResourceExists: true}},
		},
	}
