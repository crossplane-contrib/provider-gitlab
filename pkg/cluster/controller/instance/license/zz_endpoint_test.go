...
func TestGetLicenseFromSecrets(t *testing.T) {
	...
	t.Run("FromEndpointURLSecretRefWithBasicAuthSecrets", func(t *testing.T) {
		...
		params := &v1alpha1.LicenseParameters{
			LicenseEndpointURLSecretRef:      common.TestCreateSecretKeySelector("url", "url"),
			LicenseEndpointUsernameSecretRef: common.TestCreateSecretKeySelector("user", "u"),
			LicenseEndpointPasswordSecretRef: common.TestCreateSecretKeySelector("pass", "p"),
		}
	...
	cases := map[string]struct {
		...
		"FromLicenseSecretRef": {
			...
			mg:   licenseCR(),
			params: &v1alpha1.LicenseParameters{
				LicenseSecretRef: common.TestCreateSecretKeySelector("src", licenseKey),
			},
