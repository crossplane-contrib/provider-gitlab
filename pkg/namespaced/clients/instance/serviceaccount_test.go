...
func TestIsServiceAccountUpToDate(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"NameDiffers": {
			args: args{params: &v1alpha1.ServiceAccountParameters{CommonServiceAccountParameters: commonv1alpha1.CommonServiceAccountParameters{Name: "a", Username: username, Email: email}}, user: &gitlab.User{Name: "b", Username: username, Email: email}},
			want: false,
		},
		"UsernameDiffers": {
			args: args{params: &v1alpha1.ServiceAccountParameters{CommonServiceAccountParameters: commonv1alpha1.CommonServiceAccountParameters{Name: name, Username: "a", Email: email}}, user: &gitlab.User{Name: name, Username: "b", Email: email}},
			want: false,
		},
		"EmailDiffers": {
			args: args{params: &v1alpha1.ServiceAccountParameters{CommonServiceAccountParameters: commonv1alpha1.CommonServiceAccountParameters{Name: name, Username: username, Email: "a@example.org"}}, user: &gitlab.User{Name: name, Username: username, Email: "b@example.org"}},
			want: false,
		},
	}
