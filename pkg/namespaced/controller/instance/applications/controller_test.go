...
import (
	...
	instanceclient "github.com/crossplane-contrib/provider-gitlab/pkg/namespaced/clients/instance"
)
...
func withConnectionSecretRef(name string) applicationModifier {
	return func(r *v1alpha1.Application) {
		r.Spec.WriteConnectionSecretToReference = &v2.LocalSecretReference{Name: name}
	}
}
