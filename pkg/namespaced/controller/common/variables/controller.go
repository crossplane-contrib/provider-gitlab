...
func UpdateVariableFromSecret(kube client.Client, mg resource.Managed, ctx context.Context, selector *v2.LocalSecretKeySelector, params *v1alpha1.CommonVariableParameters) error {
