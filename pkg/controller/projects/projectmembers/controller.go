...
const (
	...
	errGetFailed        = "cannot get Gitlab Project Member"
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	projectMember, _, err := e.client.GetProjectMember(projectMemberID, cr.Spec.ForProvider.UserID)
	if err != nil {
		return managed.ExternalObservation{}, errors.Wrap(resource.Ignore(projects.IsErrorProjectMemberNotFound, err), errGetFailed)
	}
