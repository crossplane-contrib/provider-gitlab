...
type options struct {
	externalName        string
	parameters          *sharedProjectsV1alpha1.RunnerParameters
	setConditions       func(c ...common.Condition)
	atProvider          *sharedProjectsV1alpha1.RunnerObservation
...
func (e *External) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	*o.atProvider = runners.GenerateProjectRunnerObservation(runner)
...
func (e *External) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	runner, _, err := e.UserRunnerClient.CreateUserRunner(
		users.GenerateProjectRunnerOptions(o.parameters),
...
func isRunnerUpToDate(p *sharedProjectsV1alpha1.RunnerParameters, r *gitlab.RunnerDetails) bool { //nolint:gocyclo
