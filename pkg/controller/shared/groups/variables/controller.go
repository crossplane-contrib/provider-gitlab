...
type options struct {
	parameters     *sharedGroupsV1alpha1.VariableParameters
...
func (e *External) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	variable, res, err := e.Client.GetVariable(
		*o.parameters.GroupID,
		o.parameters.Key,
		groups.GenerateGetVariableOptions(o.parameters),
	...
	if o.valueSecretRef != nil {
		if err = e.updateVariableFromSecret(ctx, o.valueSecretRef, o.parameters); err != nil {
			return managed.ExternalObservation{}, errors.Wrap(err, ErrUpdateFailed)
		}
	}

	current := o.parameters.DeepCopy()
	groups.LateInitializeVariable(o.parameters, variable)

	// No need to update the original managed resource since we're working with pointers

	o.setConditions(xpv1.Available())

	return managed.ExternalObservation{
		ResourceExists:          true,
		ResourceUpToDate:        groups.IsVariableUpToDate(o.parameters, variable),
...
func (e *External) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	return e.create(ctx, o)
}

func (e *External) create(ctx context.Context, o *options) (managed.ExternalCreation, error) {
	if o.valueSecretRef != nil {
		if err := e.updateVariableFromSecret(ctx, o.valueSecretRef, o.parameters); err != nil {
	...
	_, _, err := e.Client.CreateVariable(
		*o.parameters.GroupID,
		groups.GenerateCreateVariableOptions(o.parameters),
		gitlab.WithContext(ctx))
	if err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, ErrCreateFailed)
	}
...
func (e *External) update(ctx context.Context, o *options) (managed.ExternalUpdate, error) {
	if o.valueSecretRef != nil {
		if err := e.updateVariableFromSecret(ctx, o.valueSecretRef, o.parameters); err != nil {
	...
	_, _, err := e.Client.UpdateVariable(
		*o.parameters.GroupID,
		o.parameters.Key,
		groups.GenerateUpdateVariableOptions(o.parameters),
		gitlab.WithContext(ctx),
	)
	return managed.ExternalUpdate{}, errors.Wrap(err, ErrUpdateFailed)
}
...
func (e *External) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	return e.delete(ctx, o)
}

func (e *External) delete(ctx context.Context, o *options) (managed.ExternalDelete, error) {
	if o.parameters.GroupID == nil {
...
func (e *External) updateVariableFromSecret(ctx context.Context, selector *xpv1.SecretKeySelector, params *sharedGroupsV1alpha1.VariableParameters) error {
