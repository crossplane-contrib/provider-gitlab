...
const (
	...
	errMissingGroupID     = "group ID is required"
)
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	reconcilerOptions := []managed.ReconcilerOption{
		managed.WithExternalConnecter(&connector{
			kube:              mgr.GetClient(),
			newGitlabClientFn: groups.NewAccessTokenClient,
		}),
...
// SetupGated adds a controller that reconciles AccessToken managed resources with CRD gate support.
